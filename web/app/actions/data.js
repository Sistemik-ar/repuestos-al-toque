...
// Estadísticas del admin para un período [from, to] (fechas 'YYYY-MM-DD'). Compara con el período
// anterior de igual largo (tendencias) y agrega por comercio / mecánico / repartidor + puntajes.
